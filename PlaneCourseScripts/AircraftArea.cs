...
namespace Aircraft
{
    public class AircraftArea : MonoBehaviour
    {
        ...
        /// <summary>
        /// Составляем список из всех объектов AircraftAgent
        /// </summary>
        ...
        /// <summary>
        /// Создаем чекпойнты вдоль сплайна(гоночного пути)
        /// </summary>
        ...
        /// <summary>
        /// Действия, совершаемые, когда скрипт запускается
        /// </summary>
        private void Awake()
        {
        ...
        /// <summary>
        /// Сбрасывает позицию агента к последенему пройденному чекпойнту в направлении к Checkpoints[NextCheckpointIndex],
        /// если randomize = True, то NextCheckpointIndex выбирается случайно
        /// </summary>
